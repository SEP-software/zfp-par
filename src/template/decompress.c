...
static void
_t2(decompress, Scalar, 1)(zfp_stream* stream, const zfp_chunk *chunk, zfp_field* field)
{
...
static void
_t2(decompress_strided, Scalar, 1)(zfp_stream* stream, const zfp_chunk *chunk,zfp_field* field)
{
...
static void
_t2(decompress_strided, Scalar, 2)(zfp_stream* stream, const zfp_chunk *chunk, zfp_field* field)
{
  Scalar* data = (Scalar*)field->data;
  size_t nx = field->nx;
  size_t ny = field->ny;
...
static void
_t2(decompress_strided, Scalar, 3)(zfp_stream* stream,const zfp_chunk *chunk, zfp_field* field)
{
  Scalar* data = (Scalar*)field->data;
  size_t nx = field->nx;
  size_t ny = field->ny;
...
static void
_t2(decompress_strided, Scalar, 4)(zfp_stream* stream, const zfp_chunk *chunk, zfp_field* field)
{
  Scalar* data = field->data;
  size_t nx = field->nx;
  size_t ny = field->ny;
